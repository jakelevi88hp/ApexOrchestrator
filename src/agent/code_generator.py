...
class CodeGenerator:
    ...
    async def generate_tool(self, tool_name: str, description: str,
                           inputs: List[str], outputs: str) -> Dict[str, Any]:
...
'''
    ...
    def generate_optimization(self, target_function: str, 
...
'''
    ...
    async def _generate_function_code(self, purpose: str, 
