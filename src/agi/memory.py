...
class EnhancedMemorySystem:
    ...
    async def retrieve_memories(
        self, query: str, memory_types: List[str] = None, limit: int = 10, similarity_threshold: float = 0.5
    ) -> List[Dict]:
    ...
    async def _search_episodic_memories(self, query: str, limit: int, similarity_threshold: float) -> List[Dict]:
    ...
    async def _search_semantic_memories(self, query: str, limit: int, similarity_threshold: float) -> List[Dict]:
    ...
    async def _search_procedural_memories(self, query: str, limit: int, similarity_threshold: float) -> List[Dict]:
    ...
    async def consolidate_memories(self):
        ...
        for memory_id, importance, created_at, access_count in memories_to_consolidate:
            ...
            cursor.execute(
                ...
                VALUES (?, ?, ?, ?, ?)
            """,
                ("episodic", memory_id, consolidation_level, "importance_based", datetime.utcnow().isoformat()),
            )
    ...
    async def create_memory_association(
        ...
        memory_type: str,
        memory_id: int,
        associated_memory_type: str,
        associated_memory_id: int,
    ...
    async def add_to_working_memory(self, item: Dict):
        ...
        self.working_memory.append({**item, "timestamp": datetime.utcnow(), "added_to_working": True})
