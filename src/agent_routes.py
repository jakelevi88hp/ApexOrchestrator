...
from agent.agent_loop import AutonomousAgent, get_agent
...
async def disable_agent(request: Request):
    ...
    try:
        ...
        return {"status": "disabled", "message": "Autonomous agent disabled"}
    except Exception as e:
...
async def disable_modifications(request: Request):
    ...
    try:
        ...
        return {"status": "disabled", "message": "Code modifications disabled"}
    except Exception as e:
...
async def start_agent_loop(request: Request, interval_seconds: int = 3600):
    ...
    try:
        ...
        if agent.running:
            return {"status": "already_running", "message": "Agent loop is already running"}
...
async def stop_agent_loop(request: Request):
    ...
    try:
        ...
        return {"status": "stopped", "message": "Agent loop stopped", "total_cycles": agent.loop_count}
    except Exception as e:
...
async def activate_kill_switch(request: Request, reason: str):
    ...
    try:
        ...
        return {"status": "activated", "message": "🚨 KILL SWITCH ACTIVATED - All operations halted", "reason": reason}
    except Exception as e:
